...
from tests.scalability.SnsPublisher import enqueue_message, send_start_run, sns_topic_exec
        ...
        try:
            for i in range(10):
                ...
                if item is None:
                    ...
                    events.request_success.fire(request_type=client_type, name=sns_topic_exec, response_time=total_time,
                                                response_length=0)
                    break
                else:
