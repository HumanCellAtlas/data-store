...
class TestEventHandlers(unittest.TestCase):
    ...
    def _verify_search_results(self, expectedHitCount):
        ...
        expected_index_document['manifest']['timestamp'] = \
            actual_index_document['manifest']['timestamp']  # Normalize timestamp for comparison
        # TODO Also need to normalize the uuids between the two documents to compare them meaninfully.
