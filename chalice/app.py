...
DEFAULT_EXECUTION_LIMIT_SECONDS = None
"""
This is how long we wait for a request if we're not running in a lambda.  If the value is None, there is no timeout.
"""
...
class DSSChaliceApp(chalice.Chalice):
    def __init__(self, *args, **kwargs):
        ...
        self._default_exptime_seconds = DEFAULT_EXECUTION_LIMIT_SECONDS
    ...
    def real_decorator(method: callable):
        ...
        def wrapper(*args, **kwargs):
            ...
            try:
                ...
                time_remaining_s = chalice_app._default_exptime_seconds  # type: typing.Optional[float]
                if chalice_app.lambda_context is not None:
