...
BUNDLE_CHECKOUT_PATTERN = f'/v1/bundles/checkout/{UUID_PATTERN}'
...
COLLECTIONS_PATTERN = f'/v1/collections/{UUID_PATTERN}'
COLLECTIONS_URI_REGEX = re.compile(COLLECTIONS_PATTERN)

ROOT_COLLECTIONS_PATTERN = f'/v1/collections'
ROOT_COLLECTIONS_URI_REGEX = re.compile(ROOT_COLLECTIONS_PATTERN)

SUBSCRIPTIONS_PATTERN = f'/v1/subscriptions/{UUID_PATTERN}'
SUBSCRIPTIONS_URI_REGEX = re.compile(SUBSCRIPTIONS_PATTERN)

ROOT_SUBSCRIPTIONS_PATTERN = f'/v1/subscriptions'
ROOT_SUBSCRIPTIONS_URI_REGEX = re.compile(ROOT_SUBSCRIPTIONS_PATTERN)

ROOT_SEARCH_PATTERN = f'/v1/search'
ROOT_SEARCH_URI_REGEX = re.compile(ROOT_SEARCH_PATTERN)

MOCK_PATTERN = f'/mock'
MOCK_URI_REGEX = re.compile(MOCK_PATTERN)
